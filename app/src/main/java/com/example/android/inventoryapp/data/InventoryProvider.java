...
public class InventoryProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PRODUCTS:
                // For the PRODUCTS code, query the inventory table directly
            ...
            case PRODUCT_ID:
                ...
                // This will perform a query on the inventory table where the _id equals 3 (eg) to
    ...
    /**
     * Insert a product into the database with the given content values. Return the new
     * contant URI for that specific row in the database
     */
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that supplier is valid
        Integer supplier = values.getAsInteger(InventoryEntry.COLUMN_SUPPLIER_NAME);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link InventoryEntry#COLUMN_PET_SUPPLIER} key is present,
